            ...
            <div className="col-lg-4 col-md-6 pt-4">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">
                    A full-stack social service provider web application.A single page web application with a dashboard for a volunteer
                    community.Users can volunteer for a task.Admins can see the volunteer tasks and change/delete them.
                  </p>
                </div>
                <div class="card-footer">
                  <div className="text-center">
