...
const SkillDetails = () => {
    return (
        <section>
            <div className=" skill-details-header py-5 mt-4 text-center">
                <div className="pt-4">
                    <h3>My Skill</h3>
                </div>
            </div>
            <div className="container">
                <div>
                    <div className=" py-5">
                        <h3 className="text-success">DEVELOPER SKILLS</h3>
                        <div className="">
                            <div className="skill-header-part">
                                <div className="row">
                                    <div className="col-lg-4 col-md-6  img-size ">
                    ...
                    <div className="pb-5">
                        <div>
                            <h3 className="text-success">OTHER EXPERIENCE</h3>
                            <div className="row">
                                <div className="col-lg-4 col-md-6  img-size">
